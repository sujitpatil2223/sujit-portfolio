...
const educationData = [
  {
    ...
    description: 'Intense training focused on backend engineering with Python, relational schema designs in MySQL, and server solutions using Django, Flask, and REST architecture alongside modern frontend technologies.',
    icon: <Award className="text-accent-cyan" size={18} />,
  },
  {
    id: 2,
    title: "Bachelor's Degree in Computer Science / Application",
  ...
  {
    id: 3,
    title: 'Higher Secondary Education (Science & IT Focus)',
    institution: 'Junior Science College',
    period: '2018 - 2020',
    location: 'Maharashtra, India',
    description: 'Foundational study focusing on mathematics, statistics, physics, and introductory computer science applications.',
